...
const Sidebar = () => {
  ...
  return (
    <WalletContextProvider>
      <div className="bg-gray-900 flex h-screen fixed w-16 sm:w-auto flex-col justify-between border-e">
        <div>
